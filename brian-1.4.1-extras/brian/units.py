...
radian = Unit.create(Dimension(), "radian", "rad")
steradian = Unit.create(Dimension(), "steradian", "sr")
hertz = Unit.create(Dimension(s= -1), "hertz", "Hz")
newton = Unit.create(Dimension(m=1, kg=1, s= -2), "newton", "N")
pascal = Unit.create(Dimension(m= -1, kg=1, s= -2), "pascal", "Pa")
joule = Unit.create(Dimension(m=2, kg=1, s= -2), "joule", "J")
watt = Unit.create(Dimension(m=2, kg=1, s= -3), "watt", "W")
coulomb = Unit.create(Dimension(s=1, A=1), "coulomb", "C")
volt = Unit.create(Dimension(m=2, kg=1, s= -3, A= -1), "volt", "V")
farad = Unit.create(Dimension(m= -2, kg= -1, s=4, A=2), "farad", "F")
ohm = Unit.create(Dimension(m=2, kg=1, s= -3, A= -2), "ohm", "ohm")
siemens = Unit.create(Dimension(m= -2, kg= -1, s=3, A=2), "siemens", "S")
weber = Unit.create(Dimension(m=2, kg=1, s= -2, A= -1), "weber", "Wb")
tesla = Unit.create(Dimension(kg=1, s= -2, A= -1), "tesla", "T")
henry = Unit.create(Dimension(m=2, kg=1, s= -2, A= -2), "henry", "H")
celsius = Unit.create(Dimension(K=1), "celsius", "degC")
lumen = Unit.create(Dimension(cd=1), "lumen", "lm")
lux = Unit.create(Dimension(m= -2, cd=1), "lux", "lx")
becquerel = Unit.create(Dimension(s= -1), "becquerel", "Bq")
gray = Unit.create(Dimension(m=2, s= -2), "gray", "Gy")
sievert = Unit.create(Dimension(m=2, s= -2), "sievert", "Sv")
katal = Unit.create(Dimension(s= -1, mol=1), "katal", "kat")
